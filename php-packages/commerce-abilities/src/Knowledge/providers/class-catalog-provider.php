 ...
 *
 * Exposes the catalogue structure — categories, attributes, product type
...
/**
 * Knowledge provider for catalogue structure — counts, category tree, attributes, and product type mix.
 */
class CatalogProvider implements KnowledgeProvider {
	...
	/**
	 * Assemble the full catalogue payload.
	 *
