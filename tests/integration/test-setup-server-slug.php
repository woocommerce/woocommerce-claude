...
class Test_Setup_Server_Slug extends WP_UnitTestCase {
	...
	public function test_distinct_slug_for_same_host_different_path() {
		$root   = SetupPage::derive_server_slug( 'https://example.com/wp-json/woocommerce-claude/mcp' );
		$shop_a = SetupPage::derive_server_slug( 'https://example.com/shop-a/wp-json/woocommerce-claude/mcp' );
		$shop_b = SetupPage::derive_server_slug( 'https://example.com/shop-b/wp-json/woocommerce-claude/mcp' );
	...
	public function test_distinct_slug_for_same_host_different_port() {
		$port_8888 = SetupPage::derive_server_slug( 'http://localhost:8888/wp-json/woocommerce-claude/mcp' );
		$port_8889 = SetupPage::derive_server_slug( 'http://localhost:8889/wp-json/woocommerce-claude/mcp' );
	...
	public function test_distinct_slug_for_different_hosts() {
		$a = SetupPage::derive_server_slug( 'https://store-a.example/wp-json/woocommerce-claude/mcp' );
		$b = SetupPage::derive_server_slug( 'https://store-b.example/wp-json/woocommerce-claude/mcp' );
	...
	public function test_slug_is_stable_for_same_url() {
		$url = 'https://example.com/wp-json/woocommerce-claude/mcp';
	...
	/**
	 * The slug always starts with `woocommerce-claude-` for namespacing, contains
	...
	public function test_slug_shape() {
		$slug = SetupPage::derive_server_slug( 'https://example.com/wp-json/woocommerce-claude/mcp' );

		$this->assertStringStartsWith( 'woocommerce-claude-', $slug );
	...
	public function test_slug_handles_empty_input() {
		$this->assertSame( 'woocommerce-claude', SetupPage::derive_server_slug( '' ) );
	}
}
