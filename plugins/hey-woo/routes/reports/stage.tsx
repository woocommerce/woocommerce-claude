/**
 * Hey Woo Reports - workflow launcher route.
 */
...
export function stage() {
	...
	return (
		<div className="hey-woo-page hey-woo-page--reports">
			<header className="hey-woo-reports-header">
				<div>
					<h1 className="hey-woo-reports-header__title">{ __( 'Reports', 'hey-woo' ) }</h1>
					<p className="hey-woo-reports-header__count">
						{ sprintf(
							/* translators: %d: number of visible reports */
							_n( '%d report', '%d reports', paginationInfo.totalItems, 'hey-woo' ),
			...
			<DataViews
				...
				searchLabel={ __( 'Search reports', 'hey-woo' ) }
				view={ view }
			/>
		</div>
	);
