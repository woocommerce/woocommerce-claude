...
export function buildWorkflowPrompt(
	...
	const lines = [
		...
		__( 'Format: write a merchant-friendly markdown report with clear section headings. Do not prefix section headings with numbers (write "## Snapshot", not "## 1. Snapshot"). Use tables when comparing multiple products, channels, or cohorts.', 'hey-woo' ),
		actionCards
