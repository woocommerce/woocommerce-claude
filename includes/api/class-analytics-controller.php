 ...
 * products, customers, attribution). Ability classes in
 * `plugin/includes/abilities/` are thin wrappers over the public
 * `fetch_*` methods here; they own the JSON schemas + permission checks,
 * this class owns the SQL.
 *
 * Historically this was a REST controller. After E5 (2026-04-17) the skills
 * are registered via the WordPress Abilities API instead, auto-exposed under
 * `wp-abilities/v1`. The class name stays for now to minimise churn across
 * `GetCustomerValueAbility` (which already calls the shared helpers) and the
 * skill-1–5 ability classes that migrate in the same commit.
 *
