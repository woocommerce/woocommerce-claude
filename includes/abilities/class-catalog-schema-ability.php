...
class CatalogSchemaAbility {
	...
	public static function register() {
		wp_register_ability(
			self::ABILITY_NAME,
			array(
				'label'               => __( 'Catalog schema', 'hey-woo' ),
				'description'         => __( 'Catalog schema — category tree, attribute terms, and product type distribution. Aggregated via the plugin\'s knowledge providers.', 'hey-woo' ),
