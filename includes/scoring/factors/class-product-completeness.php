			...
			return array(
				...
				'recommendations' => array(
					array(
						...
						'description' => 'Your store has no published products. AI systems cannot discover an empty catalog.',
						'priority'    => 'high',
					),
				),
			);
	...
	private function generate_recommendations( $issues, $total ) {
		...
		if ( $issues['missing_categories'] > 0 ) {
			$recs[] = array(
				...
				'description' => 'Categories help AI systems understand your catalog structure and make relevant recommendations.',
				'priority'    => 'medium',
				'impact'      => 'medium',
			);
		}
